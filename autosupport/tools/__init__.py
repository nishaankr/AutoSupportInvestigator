...
compute_queue_stats, escalate_ticket (docs/design/graph-design.md §3; full signatures in
tools-and-skills.md).
...
`customer_id` is closed over rather than model-suppliable (tools-and-skills.md §1)."""
